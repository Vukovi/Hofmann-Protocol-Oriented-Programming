...
Devices.IPod.hashValue //0
Devices.IPad.hashValue  //2
...
var myPhone = Device.IPhone(model: "6", memory: 64)
var myTablet = Device.IPad(model: "Pro", memory: 128)
...
//In Swift, enumerations are not limited to a list of elements. They can also contain computed properties, initializers, and methods, just like classes and structures.
...
enum Reindeer: String {
    ...
    static var allCases: [Reindeer] {
        return [Dasher, Dancer, Prancer, Vixen,
                Comet, Cupid, Donner, Blitzen, Rudolph]
    }
...
Reindeer.allCases
Reindeer.Dancer.rawValue
Reindeer.Dancer.hashValue
Reindeer.randomCase()
...
enum Book {
    ...
    func purchaseTogether(otherFormat: Book) -> Double {
...
var paperBack2 = Book.PaperBack(pageCount: 220, price: 39.99)
print("\(paperBack2.pageCount) - \(paperBack2.price)")
//These computed properties hide the complexity of the switch statement and provide a much cleaner dot syntax interface to use.


var paperBack3 = Book.PaperBack(pageCount: 220, price: 39.99)
var pdf = Book.PDF(pageCount: 180, price: 14.99)
var total = paperBack3.purchaseTogether(otherFormat: pdf)
